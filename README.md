...
## About App
This is Vue scaffolding via an Inertia frontend implementation. Inertia allows you to build modern, single-page <mark>Vue3 and vite bundling</mark> application using classic server-side routing and controllers.
